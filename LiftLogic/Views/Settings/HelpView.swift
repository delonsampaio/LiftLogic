...
struct HelpView: View {
    ...
    private static let allFAQs: [FAQItem] = [
        ...
        .init(section: "Modes", question: "What is WARMUP mode?", answer: "Automatically generates a warmup ladder based on percentages of your target weight, rounded to loadable plates, plus a 100% row showing your exact target. Defaults to 50/60/70/80/90%, fully customizable in Settings → Pro — Warmup % (add, remove, or adjust any step, up to 8 total). Tap any row to load that weight — you stay in WARMUP so you can keep working through the ladder.", isPro: true),
        ...
        .init(section: "Pro", question: "What is included in Pro?", answer: "Warmup mode, 1RM estimator, Wilks/DOTS/IPF GL Points relative strength scoring, Reverse mode, bodyweight ratio in the readout, saved setups, Barbell History, Lifting Partner Mode, Decimal Precision Lock, Accent Color, rest timer, and plate quantity limits. One-time purchase, no subscription."),
