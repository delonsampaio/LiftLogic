...
struct HelpView: View {
    ...
    private var gettingStartedSection: some View {
        Section("Getting Started") {
            ...
            FAQRow(
                ...
                answer: "After you confirm a weight and then change it, a banner appears between the plate breakdown and the − / + row showing exactly which plates to add or remove per side. Green entries mean add that plate, amber entries mean remove it. The banner disappears once you confirm the new weight or clear the bar.",
                isProFeature: false, userIsPro: isPro
            )
        }
    }
    ...
    private static let allFAQs: [FAQItem] = [
        ...
        .init(section: "Getting Started", question: "What is the add / remove per side banner?", answer: "After you confirm a weight and then change it, a banner appears showing exactly which plates to add or remove per side. Green entries mean add that plate, amber entries mean remove it. The banner disappears once you confirm the new weight or clear the bar."),
