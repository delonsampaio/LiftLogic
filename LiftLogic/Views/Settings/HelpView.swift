...
struct HelpView: View {
    ...
    private var platesAndBarSection: some View {
        Section("Plates & Bar") {
            ...
            FAQRow(
                ...
                answer: "In Settings → Plate Inventory, use the − button next to any enabled plate to set how many of that plate you own. The calculator will never suggest loading more plates than you have available. If the target weight can't be reached because your inventory is exhausted, the readout shows \"Not enough plates in inventory\" instead of the usual \"Closest\" amber warning — so you know to either increase quantities or rack a different weight.",
    ...
    private var modesSection: some View {
        Section("Modes") {
            ...
            FAQRow(
                ...
                answer: "Build a bar weight by tapping plates one at a time — useful when you're standing at the rack and want to add up what's already loaded. Tap UNDO to remove the last plate added.",
                isProFeature: true, userIsPro: isPro
            )
        }
    }
    ...
    private static let allFAQs: [FAQItem] = [
        ...
        .init(section: "Plates & Bar", question: "What are plate quantity limits?", answer: "In Settings → Plate Inventory, use the − button next to any enabled plate to set how many of that plate you own. The calculator will never suggest loading more plates than you have available. If the target weight can't be reached because your inventory is exhausted, the readout shows \"Not enough plates in inventory\" instead of the usual \"Closest\" amber warning — so you know to either increase quantities or rack a different weight.", isPro: true),
